...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-group input, .form-group select { width: 100%; padding: 0.6rem; border: 1px solid #ced4da; border-radius: 4px; font-size: 1rem; transition: border-color 0.3s; font-family: inherit; }
...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            <h2>${eleve != null ? '✏️ Modifier' : '➕ Créer'} un Élève</h2>
        </div>
        ...
        <form method="post" action="${pageContext.request.contextPath}/eleves">
            ...
            <div class="form-group">
                ...
                <input type="text" id="matricule" name="matricule" value="${eleve != null ? eleve.matricule : ''}" required maxlength="20" placeholder="Ex: E2024001">
            </div>

            <div class="form-group">
                <label for="nom">Nom <span class="required">*</span></label>
                <input type="text" id="nom" name="nom" value="${eleve != null ? eleve.nom : ''}" required maxlength="50" placeholder="Ex: DUPONT">
            </div>

            <div class="form-group">
                <label for="prenom">Prénom <span class="required">*</span></label>
                <input type="text" id="prenom" name="prenom" value="${eleve != null ? eleve.prenom : ''}" required maxlength="50" placeholder="Ex: Jean">
            </div>

            <div class="form-group">
                <label for="email">Email <span class="required">*</span></label>
                <input type="email" id="email" name="email" value="${eleve != null ? eleve.email : ''}" required maxlength="100" placeholder="Ex: jean.dupont@example.com">
            </div>
            ...
            <div class="form-group">
                ...
                <select id="filiereId" name="filiereId" required>
                    ...
                    <c:forEach var="filiere" items="${filieres}">
                        <option value="${filiere.id}" ${eleve != null && eleve.filiere.id == filiere.id ? 'selected' : ''}>
            ...
            <div class="form-actions">
                <button type="submit" class="btn btn-primary">${eleve != null ? '💾 Mettre à jour' : '➕ Créer'}</button>
                <a href="${pageContext.request.contextPath}/eleves?action=list" class="btn btn-secondary">❌ Annuler</a>
            </div>
        </form>
    </div>
</div>
