...
<head>
    ...
    <title>${cours != null ? 'Modifier' : 'Créer'} un Cours</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-group input, .form-group textarea { width: 100%; padding: 0.6rem; border: 1px solid #ced4da; border-radius: 4px; font-size: 1rem; transition: border-color 0.3s; font-family: inherit; }
...
<nav class="nav">
    <ul>
        ...
        <li><a href="${pageContext.request.contextPath}/cours?action=list" class="active">Cours</a></li>
...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            <h2>${cours != null ? '✏️ Modifier' : '➕ Créer'} un Cours</h2>
        </div>
        ...
        <form method="post" action="${pageContext.request.contextPath}/cours">
            ...
            <div class="form-group">
                ...
                <input type="text" id="code" name="code" value="${cours != null ? cours.code : ''}" required maxlength="20" placeholder="Ex: MATH101">
            </div>

            <div class="form-group">
                <label for="intitule">Intitulé <span class="required">*</span></label>
                <input type="text" id="intitule" name="intitule" value="${cours != null ? cours.intitule : ''}" required maxlength="100" placeholder="Ex: Mathématiques avancées">
            </div>

            <div class="form-group">
                <label for="credits">Crédits</label>
                <input type="number" id="credits" name="credits" value="${cours != null ? cours.credits : ''}" min="0" max="20" placeholder="Ex: 3">
            </div>

            <div class="form-group">
                <label for="description">Description</label>
                <textarea id="description" name="description" placeholder="Description du cours">${cours != null ? cours.description : ''}</textarea>
            </div>

            <div class="form-actions">
                <button type="submit" class="btn btn-primary">${cours != null ? '💾 Mettre à jour' : '➕ Créer'}</button>
                <a href="${pageContext.request.contextPath}/cours?action=list" class="btn btn-secondary">❌ Annuler</a>
            </div>
        </form>
    </div>
</div>
